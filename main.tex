...
\begin{frame}{Différences majeures avec MERISE 1}
\begin{itemize}
    \item \textbf{Orientation :} MERISE 1 est basée sur les flux de données, MERISE 2 sur les concepts orientés objet.
    \item \textbf{Technologie ciblée :} MERISE 1 se concentre sur les bases relationnelles classiques, MERISE 2 inclut les bases orientées objet.
    \item \textbf{Modélisation :} MERISE 2 enrichit les modèles classiques avec une gestion des cycles de vie.
    \item \textbf{Adaptabilité :} MERISE 2 est plus souple et évolutive que MERISE 1.
\end{itemize}
\end{frame}

\begin{frame}{Points forts de MERISE 2}
\begin{itemize}
    \item Adaptée aux environnements modernes et complexes.
    \item Intègre des paradigmes orientés objet, facilitant la modularité.
    \item Approche plus flexible, adaptée aux projets évolutifs.
\end{itemize}
\end{frame}
